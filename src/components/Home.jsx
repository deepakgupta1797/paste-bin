   ...
   const [formInitialValues, setFormInitialValues] = useState({
    ...
    useEffect(() => {
      ...
      if(pasteId){
        ...
        if (pasteToEdit) { 
          if (currentUser?.role !== 'admin' && pasteToEdit.userId !== currentUser?.id) {
          ...
          setFormInitialValues({
            ...
            tags: Array.isArray(pasteToEdit.tags) && pasteToEdit.tags.length > 0
     ...
     }, [pasteId, allPastes, setSearchParams, isAuthenticated, currentUser, navigate]);
        ...
        {({ isSubmitting, dirty, isValid }) => (
          <Form className="space-y-6">
            ...
            <div>
              <button
                type="submit"
                disabled={isSubmitting || !dirty || !isValid || !isAuthenticated}
