            ...
            return (
              <div key={blog._id} className="bg-white rounded-lg shadow-md p-6 flex flex-col justify-between">
                ...
                <div className="flex flex-wrap gap-2 mt-4 pt-3 border-t border-gray-200">
                  ...
                  <button onClick={() => handleView(blog._id)} className="px-3 py-1 text-xs font-medium bg-blue-500 text-white rounded-md hover:bg-blue-600">View</button>
                  <button onClick={() => handleCopy(blog.content)} className="px-3 py-1 text-xs font-medium bg-green-500 text-white rounded-md hover:bg-green-600">Copy Content</button>
                  <button onClick={() => handleShare(blog)} className="px-3 py-1 text-xs font-medium bg-purple-500 text-white rounded-md hover:bg-purple-600">Share</button>
                  {canEditOrDelete && (
                    <button onClick={() => handleDelete(blog._id)} className="px-3 py-1 text-xs font-medium bg-red-500 text-white rounded-md hover:bg-red-600">Delete</button>
                  )}
                </div>
              </div>
            );
