...
const ViewBlogPostPage = () => {
  ...
  if (!blogPost) {
    return (
      <div className="p-6 md:p-8 text-center bg-white rounded-lg 
      shadow-xl max-w-lg mx-auto">
        ...
        <Link 
        to="/blogs"
         className="mt-6 inline-block px-6 py-2 text-sm 
         font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700">
    ...
    <article className="bg-white p-6 md:p-8 rounded-lg shadow-xl max-w-4xl mx-auto">
      <header className="mb-8 border-b pb-4">
        ...
        <p className="text-sm text-gray-500">
          ...
          {blogPost.userId && 
          <span className="ml-2">
            by UserID: {blogPost.userId.slice(0,6)}...
            </span>}
          {blogPost.updatedAt &&
